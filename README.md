...
Projeto voltado para fins educacionais, com intenção de aprender javascript, focando nos conceitos da condicional If.


## Aprendizados

Compreendi os conceitos da condicional IF no javascript.
## Funcionalidades

- A condicional IF decide se você ganhou ou nao baseado em quanto você tirou no dado.
...
```bash
  git clone https://github.com/MateusMengardaMcM/Jogo-de-dados
```
